 ...
 *  (2) Fetch User name , Password from xls in the text boxes and click Submit
...
public class loginTest_xls {
	...
	public void test() throws IOException {
		...
		String filePath = System.getProperty("user.dir") + "/SeleniumCredentials1.xls";
		...
		for (int i = 1; i <= rowCount; i++) {
			...
			FileUtils.copyFile(scrFile, new File("C:\\Users\\Mayank\\git\\Test1\\TestNG Learning\\Message.jpg"));
