 ...
 *  (7) Practice on Drag and Drop and Frames
 *  (8) Practice on File Upload
 *  (9) Practice on Menus bar selection
 *  (10) Practice on Increment & Decrement Inputs and Horizontal Slider
 *  (11) Practice on Web Table
 *  
 */
